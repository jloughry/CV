...
\vspace{1mm}
\begin{itemize}
    \item \textbf{Certification and Accreditation Consultant} \hfill \href{http://CandAdoctor.com}%
{\nolinkurl CandAdoctor.com} \hfill 2015--present
        \vspace{-2mm}
        \begin{myquote}
            Secret-and-Below Interoperability (SABI) certification for a
            new cross domain system (CDS).
        \end{myquote}
