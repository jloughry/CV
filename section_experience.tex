...
\noindent\textbullet\ \textbf{Reader in Cybersecurity}
    ...
    \vspace{1mm}
    \noindent Teaching and research professor of computer science in the
    cybersecurity master's degree programme. Instructor in C programming,
    computer security, ethical hacking; Principal Investigator (PI) for the
    CCM project.
