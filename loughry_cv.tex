...
\vspace{-26mm}
\emph{I do software development for cross domain systems, C\&A, project lead,
\hfill and information security.}
...
USAF Rome Laboratory contract no.\ FA8750-09-C-0006, for period of
performance 2009--2012; project completed on time.
...
\begin{itemize}
	\item \href{http://google.com/patents/US8793499}{U.S.\ patent 8,793,499}
		for \emph{Nested Digital Signatures with Constant File Size}.
	\vspace{-1mm}
	\item \href{http://www.google.com/patents/US6987461}{U.S.\ patent 6,987,461}
		for a \emph{System and Method for Addressing Optical Emanations from an
...
\begin{itemize}
	\item University of Oxford, England: Ph.D.\ student, 2007--2015.
		...
		\begin{myquote}
			...
			(C\&A) testing of cross domain solutions and cross
			domain systems for Intelligence Community (IC), collateral,
			and international environments, with application to
			privacy protection of Electronic Health Record (EHR) systems.
            Dissertation: \emph{Security Test and Evaluation of Cross
            Domain Systems}, submitted Michaelmas term 2014.
		\end{myquote}
\vspace{-2.5mm}
...
counterintelligence polygraph; last investi-\\
gation date: 5th August 2009
