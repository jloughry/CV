...
%
% I also edited the ot1.cmap file in the MiKTeX/2.9/tex/latex/cmap/ directory to
% replace all instances of <201C> (Unicode left double quotation mark) and <201D>
% (Unicode right double quotation mark) with <0022> (ASCII double quote) and all
% instances of <2018> (Unicode left single quotation mark) and <2019> (Unicode
% right single quotation mark) with <0027> (ASCII single quotation mark).  This
% makes single and double quotation marks in the resulting PDF cut and paste as
% straight quotes, to make it more likely that simple keyword searches will work
% as intended.
...
% The hyperref package makes links show up in generated PDF files combined with \url.
\usepackage{hyperref}
\usepackage{url}
...
\begin{itemize}
	...
	\item[*] Programmer/Analyst II, First Interstate Bank of Washington, Seattle, from 1990--1996.
		...
		\begin{quote}\vspace{-2mm}
			...
			% with storage in the 4702 controllers.  With no way to back out changes from
			% production, we were extremely careful how we did it.}
		\end{quote}
...
\begin{itemize}
	...
	\item[*] `Efficiently enumerating the subsets of a set' by Loughry, Schoofs, and van Hemert
		(in preparation).
...
\begin{itemize}
	...
	{\color{grey}
		\item[{\includegraphics[width=1em]{twitter.png}}] Twitter:
			\url{https://twitter.com/jloughry}
		\item[{\includegraphics[width=1em]{google-plus.png}}] Google+:
			\url{https://plus.google.com/u/0/115779672587479359864/}
		\item[{\includegraphics[width=1em]{facebook.png}}] Facebook:
