...
\vspace{-32mm}
{\emph{I do software devel.\ for cross domain systems, C\&A for CDS, project lead \& information security.}}
...
\vspace{-2.5mm}
	\item Information Assurance Engineer, Lockheed Martin Corporation, 2006--2012.
		\vspace{-2mm}
		\begin{myquote}
			Proposed and won a \$900,000 Air Force Research Laboratory contract
...
\vspace{-2.5mm}
	\item System Administrator, Wells Fargo \& Company, Seattle, Washington, 1996--1997.
		\vspace{-2mm}
		\begin{myquote}
...
\vspace{-2.5mm}
	\item Programmer/Analyst II, First Interstate Bank of Washington, Seattle, 1990--1996.
		\vspace{-2mm}
		\begin{myquote}
			Developed \textbf{BANC*List}, a high-level machine code translator and cross-referencer
			that improved IBM mainframe programmer efficiency so five people
...
\begin{itemize}
	...
	\vspace{-2mm}
	\item Applications 61/774,539 and 61/879,059 have not been published yet, 2013.
\end{itemize}
