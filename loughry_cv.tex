...
%
%    \item `Cross-Domain Voice-over-IP (VoIP) Guard'. Disclosure ID
%    DA-01112 (2003).
%
%    \item `Smart Card with On-Board Guard'. Disclosure ID DA-01113
%	(2003).
%
%    \item `Visual Identification System for Cables'. Disclosure ID
%    DA-01085 (2003).
%
