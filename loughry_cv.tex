...
\begin{itemize}
	\item Postgraduate Research Student, University of Oxford, 2007--present.
		...
		\begin{myquote}
			...
			international environments, with applications to health care. Title
			of dissertation: \emph{Security Test and Evaluation of Cross Domain
			Systems}; degree expected in 2013.  Up-to-date experience with Common
			Criteria, DIACAP, and DCID 6/3 testing.
		\end{myquote}
\vspace{-2.5mm}
...
\vspace{-2.5mm}
	\item Senior Software Engineer, Lockheed Martin Missiles \& Space Company, 1998--2006.
		...
		\begin{myquote}
			...
			engineer for Radiant Mercury\rmtrademark.  An experienced programmer in C and C++
...
\vspace{-2mm}
\begin{itemize}
	\item Unlimited password retries permitted in Solaris 8, Trusted Solaris 8,
		and OpenSolaris, 2006.\vspace{-2mm}
...
\begin{itemize}
	\item OpenSolaris: \url{http://www.opensolaris.org} (2006)
		\emph{found a bug in password retry limit of Trusted Solaris 8},
		patch accepted.
...
\begin{itemize}
    \item Doctoral student, University of Oxford, Department of
		...
		Evaluation of Cross Domain Systems}, degree expected in 2013.
