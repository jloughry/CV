...
\begin{itemize}
    ...
    \item Sun Microsystems, Inc.\ security advisory (software):
		\colorbox{black}{[title redacted]} classified S//NF, 1999.
	\vspace{-2mm}
	\item Sun Microsystems, Inc.\ security advisory (hardware):
		\colorbox{black}{[redacted]} classified S//NF, 1998.
	\vspace{-2mm}
	\item Sun Microsystems, Inc.\ security advisory (software):
		\colorbox{black}{[title redacted]} classified S//NF, 1998.
	\vspace{-2mm}
	\item Sun Microsystems, Inc.\ security advisory (software):
		\colorbox{black}{[redact]} classified TS//SI TK B, 1998.
\end{itemize}
