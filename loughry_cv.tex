...
{joe@call-with-current-continuation.com}}\hfill Centennial, Colorado, USA
...
\begin{itemize}
	\item University of Oxford: Postgraduate Research Student, 2007--present.
		\vspace{-2mm}
		\begin{myquote}
			...
			and international environments, with applications to
			Electronic Health Records (EHR) privacy. Dissertation: \emph{Security
			Test and Evaluation of Cross Domain Systems}; degree expected
			in late 2014.
		\end{myquote}
\vspace{-2.5mm}
...
France, 20--22 Nov.\ 2012, pp.\ 19--28, 2012.
