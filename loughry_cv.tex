...
\providecommand{\rmtrademark}{\raisebox{\height}{\tiny\textsc{(tm)}}}
...
\begin{itemize}
	\item Postgraduate Research Student, University of Oxford, 2007--present.
		...
		\begin{myquote}
			...
			Systems}; degree expected in 2013.  Current experience with DIACAP,
			DCID 6/3, and Common Criteria testing.
		\end{myquote}
...
\vspace{-2.5mm}
	\item Information Assurance Engineer, Lockheed Martin Corporation, 2006--2012.
		...
		\begin{myquote}
			...
			evaluation of Radiant Mercury\rmtrademark\ with NSA.
		\end{myquote}
...
\vspace{-2mm}
\begin{itemize}
	\item Unlimited password retry permitted in Solaris 8, Trusted Solaris 8, and OpenSolaris,
		2006.\vspace{-2mm}
	\item Light emitting diodes leak information from many types of data communication equipment
		(a side channel),
		including plaintext from certain cryptographic hardware modules, 2002.\vspace{-1.5mm}
...
\begin{itemize}
	\item `\href{http://applied-math.org/Loughry2011.pdf}{Probabilistic Redaction' final
		...
		Available from the Defense Technical Information Center (DTIC), Washington, D.C.
