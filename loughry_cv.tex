...
\author{\hspace{-3.5mm}\vspace{-5mm}\emph{Cross Domain System Certification and Accreditation (C\&A),
...
\begin{itemize}
	\item OpenSolaris: \url{http://www.opensolaris.org} (2006) \emph{fixed bug 6329516 in
		password retry check limit}
