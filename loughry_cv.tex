...
% The cmap package avoids the problem of ligatures like 'ffi' disappearing
% from a copy and paste operation into plain text.  This is important when
% sending out résumés in PDF if you want keywords to be spotted by automated
% filters used by HR.  Without the `resetfonts' option it doesn't do the
% trick with Computer Modern Roman.
...
% The hyperref package makes links work in generated PDF files.
\usepackage{hyperref}
...
\title{\textsc{Joe Loughry}\vspace{-0.5cm}}
\author{\emph{Computer Security, Cross Domain Systems, C\&A}}
