...
\vspace{-26mm}
{\large Software Development for Cross Domain Systems, C\&A, and Information Security Research}

\vspace{3mm}
\url{mailto:rjl@applied-math.org} \hfill \url{mailto:joe.loughry@stx.ox.ac.uk}

Tel: (303) 221-4380 (time zone is US/Mountain---GMT minus 7 hours)\hfill Centennial, Colorado
...
\begin{itemize}
	...
	\item Software Engineer, Lockheed Martin IS\&GS Western Region, from February 1998--2006.
		\begin{quote}\vspace{-2mm}
			...
			a job writing code on RADIANT MERCURY.  Travelled around the U.S.\ and Britain
			writing code and got interested along the way in Certification and Accreditation
			(C\&A) of classified systems.}
		\end{quote}
