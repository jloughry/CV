...
\vspace{-2mm}
\begin{itemize}
	\item Unlimited password tries permitted in Solaris 8, Trusted Solaris 8, and OpenSolaris,
		2006.\vspace{-2.5mm}
	\item Light emitting diodes leak information from many types of data communication equipment,
		including plaintext from certain cryptographic hardware modules, 2002.\vspace{-2.5mm}
