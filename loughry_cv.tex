...
%
% I use a modified ot1.cmap file and a modified oms.cmap file in the current
% directory to tell PDF that in addition to the ligatures mentioned above it should
% also replace curly quotes with straight quotes, en dashes and em dashes with
% hyphens, and bullets with asterisks.  Copy and paste of text from the resulting
% PDF file will be 7-bit clean ASCII containing no Unicode characters at all.
%
% Be sure to load cmap immediately after the documentclass line so it can see
% all the fonts as they are loaded.
